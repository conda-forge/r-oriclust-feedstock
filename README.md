...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-oriclust-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2353&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-oriclust-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-oriclust` can be installed with:

```
conda install r-oriclust
```

It is possible to list all of the versions of `r-oriclust` available on your platform with:
